package com.andryanstgkr.desmart.utilities;
...
public class ResponseHandler {
     ...
     * @return
     */
    public static ResponseEntity<Object> generateResponse(String message, String action, HttpStatus status, Object responseObj) {
     ...
     * @return
     */
    public static ResponseEntity<Object> generateResponseMap(String message, HttpStatus status, Object responseObj,
            int totalRecord, int pageNumber, int totalPages) {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("timestamp", LocalDateTime.now().format(DateTimeFormatter.ofPattern("E, dd-MMM-yyyy HH:mm:ss")));
        map.put("message", message);
